    ...
    >
      <div className="flex flex-row items-start w-full px-7">
        ...
        <div className="w-full mr-auto">
          <h2 className="section-one-title md:text-3xl font-semibold leading-tighter tracking-tighter mb-2">
            Ship your MVP fast 🌐
          </h2>
          ...
          {/* Code */}
          <div className="section-one-code bg-white rounded-2xl shadow-sm border border-[#E9E9E9] w-full h-[460px]">
        ...
        {/* Right */}
        <div className="section-one-example ml-10 ">
          <FormExample />
        </div>
      </div>
